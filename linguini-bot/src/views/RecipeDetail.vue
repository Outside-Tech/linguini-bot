...
<template>
    <div class="principal">
            ...
            <v-row class="">
                <v-col style="margin:0; padding:0;" cols="12">
                    <div class="img_recipe">
                        <!--Aquí iría la imagen-->
                        <v-img height="100%" width="auto" src="https://img.buzzfeed.com/thumbnailer-prod-us-east-1/f7043f6c2c9246a4808265a6087c0d00/Final.jpg"></v-img>
                    </div>
                </v-col>
            </v-row>
            ...
            <v-row>
                <v-col cols="12" style="background-color: #5E3BF2;">
                    ...
                    <v-row class="justify-center">
                        ...
                        <v-col cols="7">
                            <p style="margin:0; color: white;">Enjoy the experience to cook with your favorite chef</p>
                    ...
                    <v-row class="justify-center">
                        <v-col style="padding-top:0;" cols="10">
                            <v-btn dark style="margin-top: .5rem; background: #AAB0C2; width:100%">
                                <v-icon>mdi-food</v-icon>
        ...
        <!--Bottom navigator-->
        <v-bottom-navigation class="botton_nav" grow color="#5e3bf2" :value="activeBtn">
        <v-btn>
            <span>Home</span>
